  ...
  return (
    <div className="space-y-6" id="billing-management-root">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 animate-fade-in">
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <span className="text-[10px] text-slate-400 font-bold tracking-widest block uppercase">CONTRACTED TIER RATES</span>
            <strong className="text-xl text-slate-900 font-bold block">{packages.length} Tier Structures</strong>
            <span className="text-[10px] text-slate-400 font-medium block">Multi-tenant volume rates configured</span>
          </div>
        ...
        <div className="fixed inset-0 bg-slate-900/30 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-sm overflow-hidden p-6">
            ...
            <form onSubmit={handlePaymentSubmit} className="space-y-4 text-xs">
              <div className="p-4 bg-slate-50/50 border border-slate-200 rounded-xl flex justify-between font-mono items-center">
                <div>
                  <span className="text-[9px] text-slate-400 block font-bold tracking-wider uppercase">INVOICE PREVIEW</span>
